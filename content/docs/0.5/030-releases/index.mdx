...
This is a maintenance release, ahead of the upcoming 1.0 release. Upgrade by running `npm install @theatre/core@latest @theatre/studio@latest @theatre/r3f@latest` in your project.
...
This is a maintenance release, ahead of the upcomign 1.0 release.
