...
- **New features**
  ...
  - [Extensions](/docs/latest/manual/authoring-extensions) are not hot-reloadable.
...
- **New features**
  ...
  - You can now dynamically remove objects via [`Sheet.detachObject()`](/docs/latest/manual/objects#detaching-objects).
