...
_Hint: You can control how often `sequence.play()` progresses forward by optionally providing a [`rafDriver`](/docs//docs/latest/manual/advanced#rafdrivers)._
...
_Hint: You can control how often `onChange()` calls the callback by optoinally providing a [`rafDriver`](/docs//docs/latest/manual/advanced#rafdrivers)._
