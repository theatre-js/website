...
export const ColorSchemeSwitcher = () => {
  ...
  return (
    <DropdownMenu.Root onOpenChange={fixScrollPadding}>
      <DropdownMenu.Trigger className="flex h-8 items-center rounded-md bg-transparent px-3 text-gray-400 hover:bg-gray-50 hover:text-gray-500 dark:text-gray-500 dark:hover:bg-gray-900 dark:hover:text-gray-400">
        ...
        <DropdownMenu.Item
          ...
          className={`group flex h-8 cursor-pointer items-center space-x-4 rounded-md px-3 text-sm font-medium leading-none hover:outline-none ${
            preferredColorScheme == 'light'
              ...
              : 'text-gray-500 hover:bg-gray-50 hover:text-gray-600 dark:text-gray-400 dark:hover:bg-gray-900 dark:hover:text-gray-300'
          }`}
        >
          <span className="block w-4">
            <Icon name="sun" />
